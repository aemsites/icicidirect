...
async function fetchOffers(client, sessionId, useProxy) {
    ...
    const payload = {
        context: {
            channel: 'web',
            address: {
                url: 'https://target-alloy-1--icicidirect--aemsites.hlx.live/research/equity',
            },
    ...
    const host = 'https://icicidirect-secure-worker.franklin-prod.workers.dev/'; // useProxy ? '/' : `https://${client}.tt.omtrdc.net/`;
